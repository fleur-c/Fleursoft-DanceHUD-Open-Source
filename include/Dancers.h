...
#define MessageAddDancer(avname, avkey)    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersAddDancer, avname + "|" + (string)avkey)
#define MessageRemoveDancer(avkey,releaseFlag)    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersRemoveDancer, (string)avkey + "|" + (string)releaseFlag)
#define MessageSetActiveDancers(number)    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersSetActiveDancers, (string)number)
#define MessageSetChatChannel(number)    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersSetChatChannel, (string)number)
#define MessageDCShowAll()    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersShowAll, "")
#define MessageDCLoadAllAnims()    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersLoadAllAnims, "")
#define MessageDCAutoInvite(startFlag)    llMessageLinked(LINK_THIS, Define_DANCERSADMINLINKID, (string)DancersAutoInvite, (string)startFlag)
