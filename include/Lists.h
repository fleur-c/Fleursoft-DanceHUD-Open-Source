...
#define AdminMenuSetTransparency 30
#define AdminMenuChangeHeight 10
#define AdminMenuChangeWidth 11
#define AdminMenuReset 13
#define AdminMenuReadMe 14
#define AdminMenuTransfer 15
#define AdminMenuUpdate 16
#define AdminMenuNoOp 17

#define AdminMenuDanceSelection 18
#define AdminMenuDanceDuration 19
#define AdminMenuMissingDanceWarning 20
#define AdminMenuKeepBlankLines 21
#define AdminMenuKeepCommentLines 22
#define AdminMenuKeepRepeats 23
#define AdminMenuRecordFreestyleSequences 24
#define AdminMenuTimeAnimations 25
#define AdminMenuSetUserMenu 26
#define AdminMenuPreloadAnims 27
#define AdminMenuMaxCommand AdminMenuSetTransparency
...
#define AdminMenuNumbers [AdminMenuPrevMenu, AdminMenuSync, AdminMenuAddDancer, AdminMenuRemoveDancer, \
                          ...
                          AdminMenuSetTheme, AdminMenuSetTransparency, AdminMenuChangeHeight, AdminMenuChangeWidth, \
                          AdminMenuPreloadAnims, AdminMenuReset, AdminMenuReadMe, \
                          AdminMenuTransfer, AdminMenuUpdate, \
...
#define MessageAONextStand()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_NEXTSTAND", "")
#define MessageAOSitOn()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SITON", "")
#define MessageAOSitOff()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SITOFF", "")
#define MessageAORandomStands()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_RANDOMSTANDS", "")
#define MessageAOSequentialStands()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SEQUENTIALSTANDS", "")
#define MessageAOSitAnywhereOn()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SITANYWHERE_ON", "")
#define MessageAOSitAnywhereOff()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SITANYWHERE_OFF", "")
#define MessageAOStandOn()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_STANDON", "")
#define MessageAOStandOff()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_STANDOFF", "")
#define MessageAOSelectSit()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_SITS", "")
#define MessageAOSelectWalk()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_WALKS", "")
#define MessageAOSelectGroundSit()    llMessageLinked(LINK_THIS, Define_AOLINKID, "ZHAO_GROUNDSITS", "")
