...
#define Define_INVENTORYTHEMELINKID 12123420
    // Select from a list of theme names (textures in the dancehud)
#define Define_INVENTORYTRANSPARENCYLINKID 12123432
    // Select from a list of transparency percentages
#define Define_TRANSFERLINKID 12123421
    // Menu for transfer items
#define Define_UPDATELINKID 12123431
    // Menu for updating the HUD
#define Define_PRODUCTLINKID 12123433
    // Messages related to product only handling
...
#define Define_KEEPALIVELINKID 12123430
    // Keep alive link id - there is a script that just sends messages
    //  on this link id to ALL of the scripts so they stay running
    //  MUST do this at least once per minute on opensim or the script
    //  WILL be killed. :(   (sigh)
...
#define Define_LOADANIMSMENU 12123429
